...
export const CATALOG: Sticker[] = [
  ...
  // HOLY WEEK — 23 scenes
  { id: "hwp-01", name: "Raising of Lazarus",         filename: "01 - Resurrection of Lazarus.png",        price: D2C_PRICE, category: "holy-week" },
  { id: "hwp-02", name: "Entry into Jerusalem",        filename: "02 - Jesus Entry into Jerusalem.png",     price: D2C_PRICE, category: "holy-week" },
  { id: "hwp-03", name: "Driving Out the Merchants",  filename: "03 - Jesus drives out the merchants.png", price: D2C_PRICE, category: "holy-week" },
  { id: "hwp-04", name: "Cursing the Fig Tree",        filename: "04 - Cursing the Fig Tree.png",           price: D2C_PRICE, category: "holy-week" },
  { id: "hwp-05", name: "Teaching in the Temple",      filename: "05 - Jesus teaching in the temple.png",   price: D2C_PRICE, category: "holy-week" },
  { id: "hwp-06", name: "The Wise Virgins",            filename: "06 - Jesus and the wise virgins.png",     price: D2C_PRICE, category: "holy-week" },
  { id: "hwp-07", name: "Anointing at Jesus' Feet",   filename: "07 - Anointing at Jesus_ feet.png",       price: D2C_PRICE, category: "holy-week" },
  { id: "hwp-08", name: "Judas Receives Silver",       filename: "08 - Judas Receiving Silver.png",         price: D2C_PRICE, category: "holy-week" },
  { id: "hwp-09", name: "Washing of the Feet",         filename: "09 - washing of the feet .png",           price: D2C_PRICE, category: "holy-week" },
  ...
  { id: "hwp-12", name: "Judas' Betrayal",             filename: "12 - Judas_ Betrayal.png",                price: D2C_PRICE, category: "holy-week" },
  { id: "hwp-13", name: "Before the High Priest",      filename: "13 - High Priest Judgement.png",          price: D2C_PRICE, category: "holy-week" },
  { id: "hwp-14", name: "The Rooster Crows",           filename: "14 - Rooster Craw.png",                   price: D2C_PRICE, category: "holy-week" },
  { id: "hwp-15", name: "The Scourging",               filename: "15 - Jesus_ Scourging.png",               price: D2C_PRICE, category: "holy-week" },
  { id: "hwp-16", name: "Pilate Washes His Hands",     filename: "16 - Pilate washes his hands.png",        price: D2C_PRICE, category: "holy-week" },
  { id: "hwp-17", name: "Mocked by Romans",            filename: "17 - Laughed at By Romans.png",           price: D2C_PRICE, category: "holy-week" },
  { id: "hwp-18", name: "Face on the Handkerchief",    filename: "18 - Face imprint on the handkerchief .png", price: D2C_PRICE, category: "holy-week" },
  { id: "hwp-19", name: "The Crucifixion",             filename: "19 - Crucifixion (HWP).png",              price: D2C_PRICE, category: "holy-week" },
  { id: "hwp-20", name: "Descent from the Cross",      filename: "20 - Descent from the cross.png",         price: D2C_PRICE, category: "holy-week" },
  { id: "hwp-21", name: "Tomb Burial",                 filename: "21 - Tomb Burial.png",                    price: D2C_PRICE, category: "holy-week" },
  { id: "hwp-22", name: "Christ in Hades",             filename: "22 - Christ in Hades.png",                price: D2C_PRICE, category: "holy-week" },
  { id: "hwp-23", name: "The Resurrection",            filename: "23 - Resurrection (HWP).png",             price: D2C_PRICE, category: "holy-week" },

  // RESURRECTION PACK — 10 scenes
  { id: "rp-01", name: "Resurrection with Guards",      filename: "01 - Resurrection w_ guards (RP).png",  price: D2C_PRICE, category: "resurrection" },
  { id: "rp-02", name: "The Empty Tomb",                filename: "02 - Empty tomb w_soliders.png",         price: D2C_PRICE, category: "resurrection" },
  { id: "rp-03", name: "Mary Magdalene",                filename: "03 - Mary Magdalene.png",                price: D2C_PRICE, category: "resurrection" },
  { id: "rp-04", name: "The Myrrhbearers",              filename: "04 - Myrrhbearers.png",                  price: D2C_PRICE, category: "resurrection" },
  { id: "rp-05", name: "Doubting Thomas",               filename: "05 - Doubting Thomas.png",               price: D2C_PRICE, category: "resurrection" },
  { id: "rp-06", name: "The Emmaus Disciples",          filename: "06 - Emmuas Disciples.png",              price: D2C_PRICE, category: "resurrection" },
  { id: "rp-07", name: "Appearance in the Upper Room",  filename: "07 - Apperance in the Upper Room.png",   price: D2C_PRICE, category: "resurrection" },
  { id: "rp-08", name: "Breakfast at the Sea",          filename: "08 - Breakfast at Sea.png",              price: D2C_PRICE, category: "resurrection" },
