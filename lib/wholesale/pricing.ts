...
export function getPackType(name: string, category: string, sku: string): "HWP" | "RP" | "" {
  ...
  if (pid === "RP_PACK" || pid === "PK-1" || c === "resurrection" || c.includes("resurrection pack") || n.includes("resurrection pack") || n.startsWith("rp")) return "RP";
  if (pid === "HWP_PACK" || pid === "PK-2" || c === "holy week" || c.includes("holy week pack") || n.includes("holy week pack")) return "HWP";
